...
<?php
	...
	if(isset($_POST['do']) && $_POST['do'] == "Add")
	{
        ...
        if($checkItem != 0)
        {
            ...
            $data['message'] = "Ce nom de catégorie existe déjà !";
        ...
        elseif($checkItem == 0)
        {
            ...
            $data['alert'] = "Succès"; 
            $data['message'] = "La nouvelle catégorie a été insérée avec succès !"; 
            echo json_encode($data);
            exit();
        }
    ...
    if(isset($_POST['action']) && $_POST['action'] == "Delete")
	{
        ...
        try
        {
            ...
            $con->commit();
            $data['alert'] = "Success";
            $data['message'] = "The new category has been deleted successfully !";
            echo json_encode($data);
            exit();
