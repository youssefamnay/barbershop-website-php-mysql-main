...
Page de connexion admin				</span>
					...
					if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['signin-button']))
					{
						...
						else
						{
							...
							<div class="alert alert-danger">
								...
								<div class="messages">
									<div>Email ou motdepasse sont incorrects.</div>
								</div>
							</div>
				...
				<div class="form-input">
					...
					<span class="invalid-feedback" id="required_username">Nom d'utilisateur est obligatoire</span>
				</div>
				...
				<div class="form-input">
					...
					<span class="invalid-feedback" id="required_password">Le motdepasse est obligatoire</span>
				</div>
				
				<!-- SIGN IN BUTTON -->

				<p>
					<button type="submit" name="signin-button" >Se connecter</button>
				</p>
