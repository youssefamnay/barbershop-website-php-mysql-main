    ...
    <tr>
        ...
        <th scope="col">Gérer</th>
                                                                    ...
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title" id="exampleModalLabel">Suppirmer Employee</h5>
                                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                    <span aria-hidden="true">&times;</span>
                                                                                </button>
                                                                            </div>
                                                                            <div class="modal-body">
                                                                            Voulez-vous vraiment supprimer cet employé ?</div>
                                                                            <div class="modal-footer">
                                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Annuler</button>
                                                                                <button type="button" data-id = "<?php echo $employee['employee_id']; ?>" class="btn btn-danger delete_employee_bttn">Supprimer</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                ...
                elseif($do == 'Add')
                {
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Ajouter un nouveau employe</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="employee_fname">Prenom</label>
                                            <input type="text" class="form-control" value="<?php echo (isset($_POST['employee_fname']))?htmlspecialchars($_POST['employee_fname']):'' ?>" placeholder="Prenom" name="employee_fname">
                                            <?php
...
Le prenom est obligatoire                                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="employee_lname">Nom</label>
...
Le nom est obligatoire                                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="employee_phone">Numero de telephone</label>
                                ...
                                <button type="submit" name="add_new_employee" class="btn btn-primary">Ajouter employe</button>
                                    ...
                                    try
                                    {
                                        ...
                                        ?> 
                                            ...
                                            <script type="text/javascript">
                                                swal("Nouvel employé", "Le nouvel employé a été ajouté avec succès.", "success").then((value) => 
                                                {
                ...
                elseif($do == 'Edit')
                {
                    ...
                    if($employee_id)
                    {
                        ...
                        if($count > 0)
                        {
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Modifier employee</h6>
                                </div>
                                <div class="card-body">
                                    <form method="POST" action="employees.php?do=Edit&employee_id=<?php echo $employee_id; ?>">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="employee_phone"> le numero de telephone</label>
